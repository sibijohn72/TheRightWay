...
// only valid if FordCompliance-Info.plist specifies a protocol to handle
...
- (void)applicationDidEnterBackground:(UIApplication *)application
{
    ...
    if([Utility checkForContentUpdate]){
        UILocalNotification* localNotification = [[UILocalNotification alloc] init];
        localNotification.alertBody = @"New content update is available.";
        localNotification.timeZone = [NSTimeZone defaultTimeZone];
...
- (void)alertView:(UIAlertView *)alertView didDismissWithButtonIndex:(NSInteger)buttonIndex
{
    if (buttonIndex==0) {
        isAppStoreOpen = TRUE;
        [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"itms://itunes.apple.com/us/app/the-right-way/id950707840?mt=8"]];
    }
