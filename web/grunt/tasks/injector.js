...
module.exports = {
  dev: {
    ...
    files: [
        {'temp/index.html': ['temp/vendor/**/*.js', 'temp/app/**/*.js', 'temp/cordova.js', 'temp/cordova_plugins.js']}
    ]
  },
  dist: {
    options: {
    ...
    files: [
        {'dist/index.html': ['dist/assets/vendor.js', 'dist/assets/app.js', 'cordova.js', 'cordova_plugins.js']}
    ]
  }
};